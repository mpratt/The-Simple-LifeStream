...
class HttpRequest
{
    ...
    public function fetch($url, array $params = array())
    {
        ...
        return $this->fileGetContents($url, $params);
    }
    ...
    protected function curl($url, array $params = array())
    {
        ...
        $options = $this->config['curl'] + $params + array(
            CURLOPT_FOLLOWLOCATION => true,
            CURLOPT_USERAGENT => 'Mozilla/5.0 PHP/SimpleLifestream',
            CURLOPT_ENCODING => '',
        );
     ...
     */
    protected function fileGetContents($url, $params)
    {

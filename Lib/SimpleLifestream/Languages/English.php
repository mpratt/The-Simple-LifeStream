...
class English extends Adapter
{
    ...
    protected $translation = array(
        ...
        'repo-created-branch' => 'created a new branch {link}.',
        'repo-pushed' => 'pushed a new commit to {link}.',
        'repo-pull-opened' => 'opened a new pull request for {link}.',
        'repo-pull-closed' => 'closed/fixed pull request - {link}.',
        'repo-pull-reopened' => 'reopened pull request - {link}.',
        'repo-issue-created' => 'created a new issue on {link}.', // deprecated
        'repo-issue-opened' => 'created issue - {link}.',
        'repo-issue-closed' => 'closed issue - {link}.',
        'repo-issue-commented' => 'commented on {link}.',
        'repo-fork-created' => 'forked - {link}',

...
class Spanish extends Adapter
{
    ...
    protected $translation = array(
        ...
        'repo-created-branch' => 'creó una nueva rama {link}.',
        'repo-pushed' => 'actualizó el proyecto {link}.',
        'repo-pull-opened' => 'creó un pull request - {link}.',
        'repo-pull-closed' => 'cerro/arregló el pull request - {link}.',
        'repo-pull-reopened' => 'reabrió el pull request - {link}.',
        'repo-issue-created' => 'participó en el reporte {link}',
        'repo-issue-opened' => 'creó un nuevo reporte - {link}.',
        'repo-issue-closed' => 'cerró el reporte - {link}.',
        'repo-issue-commented' => 'comentó en el reporte - {link}.',
        'repo-fork-created' => 'derivó el repositorio {link}.',
        'tweeted' => 'trinó {link}.',
